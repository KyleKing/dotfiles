# Generated by Powerlevel10k configuration wizard on 2021-10-27 at 15:31 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubie|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern'

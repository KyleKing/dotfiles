...
Read this for broader changes: debugging a step that will not run, migrating
hand-rolled steps to builtins, restructuring hooks, or writing a config from
scratch. The audit procedure and the two highest-frequency rules are in
[SKILL.md](SKILL.md).
